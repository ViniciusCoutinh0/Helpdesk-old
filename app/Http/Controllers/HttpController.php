...
class HttpController
{
    public function category(): void
    {
        ...
        $word = trim(strip_tags($stream->words));
        ...
        foreach ($items as $item) {
            if ($item->ATIVO == 'S') {
                $list['items'][] = [
                    ...
                    'is_required_attachment' => $item->UPLOAD_ARQUIVO ?? 'N',
                ];
            }
        }
        ...
        foreach ($fields as $field) {
            if ($field->ATIVO === 'S') {
                $list['fields'][] = [
                    ...
                    'field_description' => ucfirst($field->DESCRICAO_CAMPO),
                    'field_required'    => ($field->REQUERIDO == 'S' ? true : false),
                    'category_description' => $field->DESCRICAO ? ucfirst($field->DESCRICAO) : null,
